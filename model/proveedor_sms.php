...
class proveedor_sms extends fs_model
{
    ...
    {
        parent::__construct('proveedor_sms', 'plugins/sms/');
    ...
    public function enviar_sms($telefono, $mensaje)
    {
        ...
        {
            $result = $this->sms_freevoipdeal($telefono, $mensaje);
        }
        else if (strpos($this->url, 'clickatell'))
        {
            $result = $this->sms_clickatell($telefono, $mensaje);
        }
    ...
    public function sms_freevoipdeal($telefono, $mensaje)
    {
        ...
        $url = $this->url."?username=".$this->usuario."&password=".$this->password."&from=".$this->de."&to=".$telefono."&text=".rawurlencode($mensaje);
        $ch = curl_init();
    ...
    {
        $url = $this->url."?user=".$this->usuario."&password=".$this->password."&api_id=".$this->api_id."&to=".$telefono."&text=".$mensaje;
